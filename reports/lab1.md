...
*Теперь файл `lab1.md` также изменен, но не добавлен в индекс. Менять текст в уже существующем файле, `git` помечает его как ___Modified___, так как файл уже в системе. Если же добавить новый файл (текстовый или картинку), он помечается как ___Untracked___, так как для `git` это абсолютно новый объект*

![Screenshot_497.png](imgs\Screenshot_499.png)
*Теперь также показывает измениния в файле `lab1.md`*
Написал в файле README.md заголовок, информацию о дисциплине и о себе. Создал коммит с файлами `README.md` и `reports/lab1.md`.