...
*Эта команда показывает текущее состояние рабочей директории и индекса. В данном случае файлы изменены, но не добавлены в индекс.*

![Screenshot_497.png](imgs\Screenshot_497.png)
*Эта команда построчно сравнивает содержимое файлов. По умолчанию она показывает разницу между рабочей директорией и индексом.*
***